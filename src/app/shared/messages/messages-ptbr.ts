export enum Messages {
	...
	ItemCadastroErrorDetailGeneric = 'Item já adicionado ou inválido.',

	MaxLenghtItemWarnDetail = 'A Quantidade máxima de caracteres em um item é de ',
	MaxLenghtItemWarnSummary = 'Quantidade excedida.',
}
